...
namespace Pessoa
{
    class Pessoa
    {
        ...
        SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=""E:\TDS\2° Periodo\PA - Prof.Emerson\Pessoa\Pessoa\Pessoa\DbPessoa.mdf"";Integrated Security=True");
